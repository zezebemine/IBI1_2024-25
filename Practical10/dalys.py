...
if uk_dalys_mean>france_dalys_mean:
    ...
    print("the mena DALYs in France was greater than UK")

#show the two mean value
print(f"the mean DALYs in UK was {uk_dalys_mean}")
print(f"the mean DALYs in France was {france_dalys_mean}")
...
plt.xticks(uk.Year,rotation=-90) #the different numbers refer to the angle formed by the string that represents the year and the x-axis.
